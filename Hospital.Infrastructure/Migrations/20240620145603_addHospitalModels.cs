...
{
    /// <inheritdoc />
    public partial class addHospitalModels : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Rooms_HospitalInfo_HospitalId",
                        column: x => x.HospitalId,
                        principalTable: "HospitalInfo",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DoctorCharcge = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
